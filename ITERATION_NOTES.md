...
- **Next:** cover highlighter on touch (not just pen) and pinch-zoom (not just pan) in the e2e spec; consider asserting the remote-side active-stroke preview actually clears after a cancel (would need a 2-browser touch e2e).
- **Gotchas:**
