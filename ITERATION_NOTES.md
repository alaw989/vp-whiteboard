...
- **Next:** cover the highlighter on touch (not just pen) in the e2e spec; consider asserting the remote-side active-stroke preview actually clears after a cancel (would need a 2-browser touch e2e); could also assert the zoom percentage readout in the UI during a pinch.
- **Gotchas:**
